...
const platforms = [
  {
    ...
    action: { label: '下载 APK', href: 'https://ghfast.top/https://raw.githubusercontent.com/ABCJackkkk/VideoTogether-Mirror/main/site/public/downloads/app-release.apk', download: false, external: true },
    badge: '推荐',
  },
  {
    icon: Apple,
