    ...
    <footer className="bg-vt-bg py-12 px-6 border-t border-wandor-text/10">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-5 text-sm text-wandor-muted">
          <a href="https://ghfast.top/https://raw.githubusercontent.com/ABCJackkkk/VideoTogether-Mirror/main/site/public/downloads/app-release.apk" target="_blank" rel="noopener noreferrer" className="hover:text-wandor-text transition-colors">Android APK</a>
